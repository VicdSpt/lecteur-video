...
video.addEventListener("click", usePlay);
playToggler.addEventListener("click", usePlay);
...
video.addEventListener("timeupdate",  showTimeUpdate)

function showTimeUpdate(){
    current = video.currentTime;
...
muteBtn.addEventListener("click", useMute)
...
volumeSlider.addEventListener("input", useVolumeSlider)

function useVolumeSlider(){
...
fullScreenToggler.addEventListener("click", goFullscreen)
